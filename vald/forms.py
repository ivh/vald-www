...
class ExtractAllForm(LinelistConfigChoiceMixin, forms.Form):
    """Extract All form"""
...
class ExtractElementForm(LinelistConfigChoiceMixin, forms.Form):
...
class ExtractStellarForm(LinelistConfigChoiceMixin, forms.Form):
